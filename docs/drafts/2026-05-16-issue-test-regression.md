# Draft 2/3 — test_load_deactivation_zero_operating_timesteps regression

> Humanized + tech-checked draft.

---

## Title

CI: `test_load_deactivation_zero_operating_timesteps` fails on master — load 0 active timesteps drift 4 → 5
